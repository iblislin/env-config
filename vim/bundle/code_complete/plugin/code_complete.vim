...
let g:template['c']['de'] = "#define\<tab>"
let g:template['c']['in'] = "#include\<tab>\"\"\<left>"
let g:template['c']['is'] = "#include\<tab><>\<left>"
let g:template['c']['ff'] = "#ifndef\<tab>\<tab>\<c-r>=GetFileName()\<cr>\<CR>#define\<tab>\<tab>\<c-r>=GetFileName()\<cr>".
            \repeat("\<cr>",5)."#endif\<tab>\<tab>/*\<c-r>=GetFileName()\<cr>*/".repeat("\<up>",3)
let g:template['c']['for'] = "for(".g:rs."...".g:re."; ".g:rs."...".g:re."; ".g:rs."...".g:re.")\<cr>{\<cr>".
            \g:rs."...".g:re."\<cr>}\<cr>"
let g:template['c']['fori'] = "for(i=0; i<".g:rs."...".g:re."; i++)"
            \."\<cr>{"
            \."\<cr>".g:rs."...".g:re.
            \"\<cr>}"
            \."\<cr>"
let g:template['c']['forj'] = "for(j=0; j<".g:rs."...".g:re."; j++)"
            \."\<cr>{"
            \."\<cr>".g:rs."...".g:re.
            \"\<cr>}"
            \."\<cr>"
